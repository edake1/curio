...
const YEAR_DATA: Record<number, BirthYearData> = {
  ...
  1951: { song: 'Too Young',                artist: 'Nat King Cole',                movie: 'Quo Vadis',                            topTV: "Arthur Godfrey's Talent Scouts",   ticket: '$0.47', gas: '$0.27', stamp: '$0.03', newCar: '$1,570',  minWage: '$0.75', population: '2.6B', nobel: 'Léon Jouhaux (French labor rights advocate)',  event: 'Color TV broadcasts begin in the United States.' },
  ...
  1995: { song: "Gangsta's Paradise",       artist: 'Coolio ft. L.V.',              movie: 'Toy Story',                            topTV: 'Seinfeld',                         ticket: '$4.35', gas: '$1.15', stamp: '$0.32', newCar: '$17,800', minWage: '$4.25', population: '5.7B', nobel: 'Joseph Rotblat & Pugwash Conferences (nuclear arms)', event: 'Windows 95 launches. Everyone gets a computer. eBay is born.' },
  ...
  1997: { song: 'Candle in the Wind 1997',  artist: 'Elton John',                   movie: 'Titanic',                              topTV: 'Seinfeld',                         ticket: '$4.59', gas: '$1.23', stamp: '$0.32', newCar: '$18,700', minWage: '$5.15', population: '5.9B', nobel: 'Jody Williams & ICBL (anti-landmine campaign)',  event: 'Princess Diana dies. The world mourns together. Harry Potter is published.' },
  ...
  2025: { song: 'APT.',                     artist: 'ROSÉ & Bruno Mars',            movie: 'Ne Zha 2',                             topTV: 'Sunday Night Football',            ticket: '$12.10', gas: '$3.10', stamp: '$0.73', newCar: '$46,800', minWage: '$7.25', population: '8.2B', nobel: 'Maria Corina Machado (democracy in Venezuela)',  event: 'DeepSeek shocks Silicon Valley. AI agents go mainstream. The world accelerates.' },
};
